...
plot(combined_results$combined_state)

## use plot on county data
## scenario one
plot(combined_results$combined_county, state = "NC", direction="top", n = 20)
## scenario two
plot(combined_results$combined_county, state = "SC", direction="bottom", n = 7)
## scenario three
plot(combined_results$combined_county)
##scenario four
plot(combined_results$combined_county, state = "PA", direction="top", n = 8)
